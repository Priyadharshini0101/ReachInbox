...
function RightSection({currentMail}) {
  return (
    ...
    <div className='bg-[#ECEFF3] dark:bg-[#23272C] p-[8px] text-white text-[14px] font-semibold rounded-lg'>Lead Details</div>
    ...
    <div className='bg-[#23272C] p-[8px] text-white text-[14px] bg-[#ECEFF3] dark:bg-[#23272C]  font-semibold rounded-lg'>Activities</div>
    <div className='flex flex-col gap-[20px] px-[12px] py-[8px]'>
      <h1 className='font-semibold text-[15px] text-black dark:text-white px-[8px]'>Campaign Name</h1>
