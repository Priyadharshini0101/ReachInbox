...
<button className="dark:bg-[#25262b] w-[32px] h-[32px] border-[1px] p-[8px] border-[#DFE3E8] dark:border-gray-900 rounded-md" onClick={() => reload()}><img src={refresh} className=''></img></button>
    </div>
    <div className='flex px-[10px] text-[14px]  gap-[5px] items-center'>
      <h1 className='font-bold text-black dark:text-white'>{data.length}/25</h1>
    ...
    <div className='flex justify-between px-2.5 '>
      ...
      <div class="my-2 inline-flex mr-[5px] items-center justify-center w-6 h-6 text-xs font-semibold  bg-gray-200 dark:bg-[#222426] text-[#5C7CFA] rounded-full ">{data.length}</div>
    <h1 className='text-black dark:text-[#e6e6e6]  text-[14px] font-semibold inline-flex items-center'>New Replies</h1></div>
<h1 className='text-black dark:text-[#e6e6e6] font-semibold text-[14px] gap-[16px]  inline-flex items-center '>Newest<MdOutlineKeyboardArrowDown className="w-[18px] h-[18px] cursor-pointer" /></h1>
